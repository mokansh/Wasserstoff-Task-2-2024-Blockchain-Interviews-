...
contract Stake is OwnableUpgradeable, ReentrancyGuard {
    ...
    */
    ...
    mapping(uint256 => uint256) public rewardPercent; // Mapping of time to reward percent
    ...
    */
    function initialize(IERC20 _token, address owner_) public initializer {
        ...
        rewardPercent[30] = 200;        // will be 30 days on mainnet
        rewardPercent[60] = 400;        // will be 60 days on mainnet
        rewardPercent[90] = 600;        // will be 90 days on mainnet
    }
    ...
    */
    ...
    function setRewardPercent(uint256 _time, uint256 _percentInBP)
        ...
        onlyOwner
    {
        require(_percentInBP > 0 && _percentInBP <= 2000, "Not in Range");
